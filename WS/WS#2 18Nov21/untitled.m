...
num_windows = 360;% # of windows
time_g = time_s/num_windows;%duration of each sample

sample_size = round(length(s)/num_windows); %size of each sample

x_l_sampled = zeros(sample_size,num_windows);
x_r_sampled = zeros(sample_size,num_windows);

l_r_cross = zeros(sample_size*2-1,num_windows);%2 times the signal
